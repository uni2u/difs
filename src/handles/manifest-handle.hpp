...
#ifndef REPO_HANDLES_MANIFEST_HANDLE_HPP
#define REPO_HANDLES_MANIFEST_HANDLE_HPP
...
/**
 * @brief ManifestHandle provides basic credit based congestion control.
 *
 ...
 */
class ManifestHandle : public CommandBaseHandle
{
...
private: // insert state check command
  ...
  void
  handleFindCommand(const Name& prefix, const Interest& interest);
...
#endif // REPO_HANDLES_MANIFEST_HANDLE_HPP
